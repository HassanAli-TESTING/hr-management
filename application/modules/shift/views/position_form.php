        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php echo  form_open('shift/shifts/create_shift') ?>
                        <!-- <div class="form-group row">
                            <label for="position_name" class="col-sm-3 col-form-label"><?php echo display('position_name') ?> *</label>
                            <div class="col-sm-9">
                                <input name="shift_name" class="form-control" type="text" placeholder="<?php echo display('position_name') ?>" id="position_name">
                            </div>
                        </div> -->

                        <div class="form-group row">
                            <label for="shift_name" class="col-sm-3 col-form-label"><?php echo display('shift_name') ?></label>
                            <div class="col-sm-9">
                                <textarea name="shift_name" class="form-control"  placeholder="<?php echo display('shift_name') ?>" id="shift_name" ></textarea>
                            </div>
                        </div> 
